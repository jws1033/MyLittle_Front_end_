...
class ShowStudent extends Component {
  ...
  async componentDidMount() {
    ...
    this.state.studentArray.map((students) => {
      ...
      if (
        students[1] == this.props.match.params.gender &&
        students[4] == this.props.match.params.subject
      ) {
          ...
          {this.state.studentArray.map((students) => (
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-title">이름 : {students[0]}</div>
                ...
                <button
                  class="btn btn-info newapply-btn"
                  onClick={() => {
                    storehash.methods
                      .getStudentResume(students[5])
                      .send({
                      ...
                      .then((result) => {
                        ...
                        window.location.href =
                          "http://gateway.ipfs.io/ipfs/" + `${students[5]}`;
                      });
                  }}
                >
                  학생 이력서 다운로드
